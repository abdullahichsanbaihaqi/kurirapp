...
public class PODActivity extends AppCompatActivity {
    ...
    String URL = "https://app.bestindo-express.co.id/api2/list_resi_pod";
    String iduser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_o_d);

        iduser = SharedData.getKey(PODActivity.this, "iduser");
        String username = SharedData.getKey(PODActivity.this, "username");
        ...
        listSelect();
        spinner.setAdapter(new ArrayAdapter<>(PODActivity.this,android.R.layout.simple_list_item_1,listSelect));
...
//                    loading = DialogUtils.showProcessingMessage(SaleActivity.this, "Loading..",60);
                    ...
                    AwbList.add(new ListAwb(sNumber,1,"pod",PODActivity.this));
    ...
    private void getdata(){
        ...
        loading = DialogUtils.showProcessingMessage(PODActivity.this, "Proses..",30);
        ...
        for (int i=0; i<data2.size(); i++) {
            ...
            AwbList.add(new ListAwb(awb,0,"pod",PODActivity.this));
    ...
    public void back(View v){
        ...
        Intent myIntent = new Intent(PODActivity.this,
                HomeActivity2.class);
        PODActivity.this.startActivity(myIntent);
    }
